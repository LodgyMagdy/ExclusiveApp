      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-1">
                ...
                <span className="mb-6 text-2xl block">{product.price} EGP</span>
                <p className="text-sm border-b border-b-gray-400 pb-6 mb-6">{product.description}</p>
                <div className="flex gap-5 mb-10">
                  <AddToCartBtn productId={product._id} className="grow-1 cursor-pointer" variant={"destructive"}/>
                  <AddToWishlistBtn productId={product._id} variant={"outline"} className="cursor-pointer"/>
                </div>
