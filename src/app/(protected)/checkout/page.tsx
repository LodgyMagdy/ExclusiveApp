...
import { AddressFormPayload, addressFormSchema, addressFormState } from "@/schema/address.schema"
...
export default function CheckoutPage() {
  ...
  const form = useForm<AddressFormPayload>({ resolver: zodResolver(addressFormSchema), defaultValues: { cartId: "", details: "", city: "", phone: "" , paymentMethod: "cash" } })
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="12 Al-Masri Tower, El Gezira Street, Zamalek" {...field} />
                    </FormControl>
