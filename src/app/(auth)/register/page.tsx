...
export default function RegisterPage() {
  ...
  const form = useForm<RegisterFormPayload>({resolver: zodResolver(registerFormSchema) , defaultValues: {name: "" , email: "" , password: "" , rePassword: "" , phone: ""}})
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="username@gmail.com" {...field} type="email"/>
              </FormControl>
